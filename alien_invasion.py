...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        """Crete a new bullet and add it to the the bullets group."""
        if len(self.bullets) < self.settings.bullets_allowed:
            new_bullet = Bullet(self)
            self.bullets.add(new_bullet)
    
    def _update_bullets(self):
        """Update position of bullets and get rid of oldbullets."""
    ...
    def _create_fleet(self):
        ...
        # Create an alien and find out the number of aliens in a row.
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Decrement shps_left, and update scoreboard.
